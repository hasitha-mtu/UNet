...
def get_model2():
    ...
    p2, c2 = Encoder(32, 0.1, name="Encoder2")(p1)
    p3, c3 = Encoder(64, 0.2, name="Encoder3")(p2)
    p4, c4 = Encoder(128, 0.2, name="Encoder4")(p3)

    # Encoding layer : Latent representation
    e = Encoder(256, 0.3, pooling=False)(p4)

    # Decoder Network : Up sampling phase
    d1 = Decoder(128, 0.2, name="Decoder1")([e, c4])
    d2 = Decoder(64, 0.2, name="Decoder2")([d1, c3])
    d3 = Decoder(32, 0.1, name="Decoder3")([d2, c2])
    d4 = Decoder(16, 0.1, name="Decoder4")([d3, c1])
...
def get_model3():
    unet_inputs = Input(shape=(256, 256, 3), name="UNetInput")
    # Encoder Network : Down sampling phase
    p1, c1 = Encoder(32, 0.1, name="Encoder1")(unet_inputs)
    ...
    # Decoder Network : Up sampling phase
    d1 = Decoder(256, 0.2, name="Decoder1")([e, c4])
    d2 = Decoder(128, 0.2, name="Decoder2")([d1, c3])
    d3 = Decoder(64, 0.1, name="Decoder3")([d2, c2])
    d4 = Decoder(32, 0.1, name="Decoder4")([d3, c1])
